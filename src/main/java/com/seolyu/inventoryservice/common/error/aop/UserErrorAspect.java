package com.seolyu.inventoryservice.common.error.aop;

import com.seolyu.inventoryservice.common.utils.SlackWebhookUtil;
...
public class UserErrorAspect {
    ...
    public void sendSlackErrorAlam(JoinPoint joinPoint, Object returnValue) {
        ...
        String title = "[inventory-service] 500번대(서버) 오류가 났어요! [requestId] " + requestId;
        try {
